...
import app.com.perfec10.fragment.login.signUp.signUP.TermCoditionsActivityFaceBook;
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for(int i=0;i<array.length();i++){
                                ...
                                String social_id=obj.getString("social_id");
                                Log.d("TAGS"," isAcceptedTermsConditions :"+isAcceptedTermsConditions);


                                if(isAcceptedTermsConditions==0 && social_id ==null){
                                ...
                                if(isAcceptedTermsConditions==0 && social_id !=null ){
                                    MainActivity.clearBackStack();
                                    startActivity(new Intent(mainActivity, TermCoditionsActivityFaceBook.class)
                                            .setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK));
                                    mainActivity.finish();
                                }
                            }
