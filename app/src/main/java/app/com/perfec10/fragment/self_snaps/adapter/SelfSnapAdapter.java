...
*/
        ...
        if (postList.get(position).getTotalLike() == 1) {
            ...
            if (id.equals(preferenceManager.getKeyUserId())){
                holder.tv_likename_selfrow.setText(/*postList.get(position).getLikeName1()*/  "You liked it");
            }else {
            ...
            case 200:
                try {
                    if (requestCode==1){
                        ...
                        notifyDataSetChanged();
                        if(postList.isEmpty()) {
                            if (message.contains("Your post has been successful deleted.")) {
                                SelfSnaps.ll_header.setVisibility(View.GONE);
    ...
    public class Holder extends RecyclerView.ViewHolder {
        ...
        private LinearLayout ll_like_selfrow, ll_comm_selfrow, ll_share_selfrow, ll_detail_selfrow;
